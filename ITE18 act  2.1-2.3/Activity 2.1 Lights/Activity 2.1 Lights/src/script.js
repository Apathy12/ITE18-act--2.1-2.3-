...
const directionalLight = new THREE.DirectionalLight(0xaffffc, 0.3)
directionalLight.position.set(0, 0.25, 0)
scene.add(directionalLight)

const hemisphereLight = new THREE.HemisphereLight(0xff0000, 0x00fffc, 0.4)
scene.add(hemisphereLight)

const rectAreaLight  = new THREE.RectAreaLight(0x00aaaa, 2,1,1)
rectAreaLight.position.set(-1.5, 0, 1.5)
rectAreaLight.lookAt(new THREE.Vector3())
scene.add(rectAreaLight)

const spotLight = new THREE.SpotLight(0x7F00FF, 5, 2, 2, 2, 2)
scene.add(spotLight)
