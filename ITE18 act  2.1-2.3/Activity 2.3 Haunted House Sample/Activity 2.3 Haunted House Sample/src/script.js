...
for (let i = 0; i < 50; i++) {
    ...
    const x = Math.cos(angle) * radius // Get the x position using
    // cosinus
    const z = Math.sin(angle) * radius // Get the z position using
    // sinus
...
renderer.shadowMap.type = THREE.PCFSpftShadowMap
